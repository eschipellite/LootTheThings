...
:: Android packaging
set AND_CERT_NAME="LootTheThings"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\LootTheThings.p12
...
set IOS_PROVISION=cert\LootTheThings.mobileprovision
...
set APP_ID=air.LootTheThings

:: Output packages
set DIST_PATH=dist
set DIST_NAME=LootTheThings
